...
class OpenApi31UnitTest extends AbstractServerTest {
    ...
    void shouldParseOpenApi31TypeArrays() throws Exception {
        ...
        assertThat(accessedMessages.size(), is(notNullValue()));
    ...
    @Test
    void shouldHandleOpenApi31WithTypeArraysInRequestBody() throws Exception {
        // Given
        this.nano.addHandler(new PlainResponseServerHandler());
        ...
        // When
        requestor.run(converter.getRequestModels(null));
        // Then - verify request body with type arrays was generated
        HttpMessage bodyMessage =
                accessedMessages.stream()
                        .filter(
                                m -> {
                                    try {
                                        return m.getRequestHeader()
                                                .getURI()
                                                .getPath()
                                                .contains("/body/json");
                        ...
                        .findFirst()
                        .orElse(null);
        assertThat(bodyMessage, is(notNullValue()));
        assertThat(bodyMessage.getRequestBody().toString(), is(notNullValue()));
    }
