    ...
    private void loadPlan(File f) {
        try {
            ...
            if (progress.hasErrors()) {
                View.getSingleton().showWarningDialog(listToStr(progress.getErrors())); // TODO
            } else if (progress.hasWarnings()) {
                View.getSingleton().showWarningDialog(listToStr(progress.getWarnings())); // TODO
            }

        } catch (Exception e) {
            View.getSingleton().showWarningDialog(e.getMessage()); // TODO
        }
    }
