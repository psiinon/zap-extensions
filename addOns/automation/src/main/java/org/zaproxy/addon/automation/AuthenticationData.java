            ...
            switch (getMethod().toLowerCase(Locale.ROOT)) {
                ...
                case AuthenticationData.METHOD_OAUTH2:
                    ...
                    if (oauth2Type != null) {
                        ...
                        JobUtils.setPrivateField(
                                am,
                                AuthenticationData.PARAM_GRANT_TYPE,
                                env.replaceVars(
                                        getParameters().get(AuthenticationData.PARAM_GRANT_TYPE)));
                        JobUtils.setPrivateField(
                                am,
                                AuthenticationData.PARAM_TOKEN_ENDPOINT,
                                env.replaceVars(
                                        getParameters()
                                                .get(AuthenticationData.PARAM_TOKEN_ENDPOINT)));
