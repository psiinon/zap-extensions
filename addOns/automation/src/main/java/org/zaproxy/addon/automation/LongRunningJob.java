...
/**
 * Interface for automation jobs that run for an extended period.
 *
 * <p>Jobs implementing this interface provide a unique identifier, progress information, and can be
 * stopped.
 */
