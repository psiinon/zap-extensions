...
class AutomationEnvironmentUnitTest {
    ...
    void shouldSucceedWithValidContextWithMultipleUrls() {
        ...
        assertThat(contextWrappers.get(0).getUrls().contains(exampleUrl1), is(equalTo(true)));
        assertThat(contextWrappers.get(0).getUrls().contains(exampleUrl2), is(equalTo(true)));
        assertThat(contextWrappers.get(0).getUrls().contains(exampleUrl3), is(equalTo(true)));
        assertThat(contexts.size(), is(equalTo(1)));
