...
class SpiderJobUnitTest extends TestUtils {
    ...
    void shouldRequestContextUrl() throws Exception {
        ...
        given(extensionLoader.getExtension(ExtensionHistory.NAME)).willReturn(extHistory);
    ...
    void shouldFailIfInvalidHost() throws Exception {
        ...
        Context context = mock(Context.class);
        ContextWrapper contextWrapper = new ContextWrapper(context);
        contextWrapper.addUrl("http://null/");
    ...
    public class TestServerHandler extends NanoServerHandler {
