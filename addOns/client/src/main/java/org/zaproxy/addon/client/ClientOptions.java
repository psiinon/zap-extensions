...
public class ClientOptions extends VersionedAbstractParam {
    ...
    public static final int DEFAULT_ASCAN_BROWSER_POOL_SIZE = 2;
    public static final int MIN_ASCAN_BROWSER_POOL_SIZE = 1;
    public static final int MAX_ASCAN_BROWSER_POOL_SIZE = 10;
    ...
    private static final String ASCAN_BROWSER_POOL_SIZE_KEY =
            CLIENT_BASE_KEY + ".ascanBrowserPoolSize";
    ...
    private int ascanBrowserPoolSize = DEFAULT_ASCAN_BROWSER_POOL_SIZE;
    ...
    protected void parseImpl() {
        ...
        this.ascanBrowserPoolSize =
                clamp(
                        getInt(ASCAN_BROWSER_POOL_SIZE_KEY, DEFAULT_ASCAN_BROWSER_POOL_SIZE),
                        MIN_ASCAN_BROWSER_POOL_SIZE,
                        MAX_ASCAN_BROWSER_POOL_SIZE);
    ...
    public int getAscanBrowserPoolSize() {
        return ascanBrowserPoolSize;
    }

    public void setAscanBrowserPoolSize(int size) {
        this.ascanBrowserPoolSize =
                clamp(size, MIN_ASCAN_BROWSER_POOL_SIZE, MAX_ASCAN_BROWSER_POOL_SIZE);
        getConfig().setProperty(ASCAN_BROWSER_POOL_SIZE_KEY, this.ascanBrowserPoolSize);
    }
