 ...
 */
public class ExampleClientActiveScanRule extends ClientActiveScanRule {

    private static final Logger LOGGER = LogManager.getLogger(ExampleClientActiveScanRule.class);
    ...
    protected void scanClientNode(ClientNode node, WebDriver driver) {
        ...
        LOGGER.info(
                "Example Client Active Scan Rule 1 called for node: {} (driver: {})", url, driver);
    }
    ...
    public String getName() {
        return Constant.messages.getString("client.ascan.example.name");
    }
