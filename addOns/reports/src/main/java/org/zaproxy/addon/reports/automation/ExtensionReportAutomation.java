...
public class ExtensionReportAutomation extends ExtensionAdaptor {
    ...
    public ExtensionReportAutomation() {
        super(NAME);
        System.out.println("SBSB ExtensionReportAutomation constructor"); // TODO
    }
    ...
    // TODO
    public void addJobDataToResultData(ReportData reportData) {
        ExtensionAutomation extAuto =
                Control.getSingleton().getExtensionLoader().getExtension(ExtensionAutomation.class);
        System.out.println(
                "SBSB ExtReportAuto autoJobs " + extAuto.getAutomationJobs().size()); // TODO
        AutomationJob pscanJob = extAuto.getAutomationJobs().get(PassiveScanWaitJob.JOB_NAME);
        System.out.println("SBSB ExtReportAuto pscanJob=" + pscanJob); // TODO
        if (pscanJob != null) {
            for (JobResultData jobData : pscanJob.getJobResultData()) {
