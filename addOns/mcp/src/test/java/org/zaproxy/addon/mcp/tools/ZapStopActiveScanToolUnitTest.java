...
/** Unit tests for {@link ZapStopActiveScanTool}. */
class ZapStopActiveScanToolUnitTest {

    private ExtensionLoader extensionLoader;
    private ExtensionAutomation extAutomation;
    private ZapStopActiveScanTool tool;
    ...
    void setUp() {
        ...
        tool = new ZapStopActiveScanTool();
    }

    @Test
    void shouldReturnCorrectNameAndInputSchema() {
        assertThat(tool.getName(), equalTo("zap_stop_active_scan"));
        ...
        assertThat(
                ...
                containsString(
                        Constant.messages.getString(
                                "mcp.tool.stopactivescan.error.missingscanid")));
    }
    ...
    void shouldThrowExceptionWhenScanNotFound() {
        ...
        assertThat(
                ...
                containsString(
                        Constant.messages.getString(
                                "mcp.tool.stopactivescan.error.scanidnotfound", "ascan-1")));
    }
    ...
    void shouldStopScanSuccessfully() throws McpToolException {
        ...
        verify(extAutomation).stopLongRunningJob("ascan-1");
    }
    ...
    void shouldReturnSuccessMessageOnStop() throws McpToolException {
        ...
        assertThat(
                result.text(),
                containsString(Constant.messages.getString("mcp.tool.stopactivescan.success")));
    }
}
