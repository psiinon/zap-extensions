...
/** Unit tests for {@link ZapGetActiveScanStatusTool}. */
class ZapGetActiveScanStatusToolUnitTest {

    private ExtensionLoader extensionLoader;
    private ExtensionAutomation extAutomation;
    private ZapGetActiveScanStatusTool tool;
    ...
    void setUp() {
        ...
        tool = new ZapGetActiveScanStatusTool();
    }

    @Test
    void shouldReturnCorrectName() {
        assertThat(tool.getName(), equalTo("zap_get_active_scan_status"));
    }
    ...
    void shouldThrowExceptionWhenScanNotFound() {
        ...
        assertThat(
                ...
                containsString(
                        Constant.messages.getString(
                                "mcp.tool.getactivescanstatus.error.scanidnotfound", "ascan-1")));
    }
