...
public interface McpResource {
    ...
    /**
     * Returns the URI to advertise in {@code resources/list}. For template-style resources this may
     * include a placeholder (e.g. {@code zap://alerts/{alertRef}}). Defaults to {@link #getUri()}.
     *
     * @return the list URI, which may be a URI template
     */
    default String getUriTemplate() {
        return getUri();
    }
