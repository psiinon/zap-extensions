...
public class McpConfigJobDialog extends StandardFieldsDialog {
    ...
    private static final String RECORD_IN_HISTORY_PARAM = "mcp.configjob.dialog.recordinhistory";
    ...
    public McpConfigJobDialog(McpConfigJob job) {
        ...
        this.addTextField(SECURITY_KEY_PARAM, p.getSecurityKey() != null ? p.getSecurityKey() : "");
        this.addCheckBoxField(RECORD_IN_HISTORY_PARAM, Boolean.TRUE.equals(p.getRecordInHistory()));
        this.addPadding();
    }
    ...
    public void save() {
        ...
        job.getParameters().setRecordInHistory(this.getBoolValue(RECORD_IN_HISTORY_PARAM));
