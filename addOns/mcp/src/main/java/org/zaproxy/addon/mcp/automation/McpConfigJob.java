...
public class McpConfigJob extends AutomationJob {
    ...
    public McpConfigJob() {
        this.extMcp = Control.getSingleton().getExtensionLoader().getExtension(ExtensionMcp.class);
        ...
        parameters.setRecordInHistory(p.isRecordInHistory());
    }
    ...
    public void runJob(AutomationEnvironment env, AutomationProgress progress) {
        ...
        if (parameters.getRecordInHistory() != null) {
            mcpParam.setRecordInHistory(parameters.getRecordInHistory());
        }
    ...
    public static class Parameters extends AutomationData {
        ...
        private Boolean recordInHistory;
        ...
        public Boolean getRecordInHistory() {
