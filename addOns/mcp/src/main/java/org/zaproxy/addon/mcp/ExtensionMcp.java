...
import org.zaproxy.addon.mcp.tools.ZapGetClientSpiderStatusTool;
...
import org.zaproxy.addon.mcp.tools.ZapStopClientSpiderTool;
...
public class ExtensionMcp extends ExtensionAdaptor {
    ...
    public void hook(ExtensionHook extensionHook) {
        ...
        toolRegistry.registerTool(new ZapSendRequestTool());
        ...
        toolRegistry.registerTool(new ZapStartClientSpiderTool());
        toolRegistry.registerTool(new ZapStopClientSpiderTool());
        toolRegistry.registerTool(new ZapGetClientSpiderStatusTool());
